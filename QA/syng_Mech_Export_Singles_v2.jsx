...
// To-do:
// + Bug: ruler must be in inches
// + Bug: JPG Cover focus
// + Bug: page number issue (if pages contain numbers)
// [DONE] Disable two-step alert.
// + Feature: pick your export features?
// + Feature: cancel during save prompt
// + Feature: Export exact JPG height
...
function HR_crops(){
    //create a crops offset variable by pulling the bleed offset
    var bleedBleed = app.activeDocument.documentPreferences.documentBleedTopOffset;
    d = app.activeDocument;
    // d.pageMarksOffset = app.activeDocument.documentPreferences.documentBleedTopOffset;
    // d.documentBleedUniformSize = false;
