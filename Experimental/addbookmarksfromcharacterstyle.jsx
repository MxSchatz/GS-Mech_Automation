//DESCRIPTION:Apply Bookmarks to a particular character style from a UI.
...
myStyle = SelectCharacter();

function SelectCharacter(){
mydialog = app.dialogs.add({name:"Source Character Style", canCancel:true});
myStyles = aDoc.allCharacterStyles;
var mystring = [];
for (aa = 0; aa < myStyles.length; aa ++){
mystring[aa] = myStyles[aa].name;
if (myStyles[aa].parent.constructor.name == "CharacterStyleGroup") mystring[aa]+=" ["+myStyles[aa].parent.name+"]";
}
